package com.ncst.vehicle.module.system.enums.sms;

import cn.hutool.core.util.ArrayUtil;
import com.ncst.vehicle.framework.common.core.IntArrayValuable;
...
public enum SmsSceneEnum implements IntArrayValuable {
    ...
    ADMIN_MEMBER_REGISTRY(22, "admin-sms-registry", "后台用户 - 手机号注册");
