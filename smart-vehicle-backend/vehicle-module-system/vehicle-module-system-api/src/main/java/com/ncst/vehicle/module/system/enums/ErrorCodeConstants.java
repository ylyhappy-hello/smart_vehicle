package com.ncst.vehicle.module.system.enums;
...
public interface ErrorCodeConstants {
    ...
    // ========== 短信验证码 1002014000 ==========
    ErrorCode SMS_CODE_NOT_FOUND = new ErrorCode(1002014000, "短信验证码不存在");
    ErrorCode SMS_CODE_EXPIRED = new ErrorCode(1002014001, "短信验证码已过期");
    ErrorCode SMS_CODE_USED = new ErrorCode(1002014002, "短信验证码已使用");
    ErrorCode SMS_CODE_NOT_CORRECT = new ErrorCode(1002014003, "短信验证码不正确");
    ...
    ErrorCode SMS_CODE_IS_UNUSED = new ErrorCode(1002014007, "短信验证码未被使用");
    ErrorCode SMS_CAPTCHA_CODE_NOT_CORRECT = new ErrorCode(1002014008, "图片验证失败");
