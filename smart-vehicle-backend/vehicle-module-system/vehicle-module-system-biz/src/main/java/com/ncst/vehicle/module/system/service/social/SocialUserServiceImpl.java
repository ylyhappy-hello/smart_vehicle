...
import com.ncst.vehicle.framework.common.util.http.HttpUtils;
...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    @Resource// 由于自定义了 VehicleAuthRequestFactory 无法覆盖默认的 AuthRequestFactory，所以只能注入它
    private VehicleAuthRequestFactory vehicleAuthRequestFactory;
    ...
    public String getAuthorizeUrl(Integer type, String redirectUri) {
        ...
        AuthRequest authRequest = vehicleAuthRequestFactory.get(SocialTypeEnum.valueOfType(type).getSource());
        // 生成跳转地址
