package com.ncst.vehicle.module.system.mq.consumer.sensitiveword;

import com.ncst.vehicle.framework.mq.core.pubsub.AbstractChannelMessageListener;
import com.ncst.vehicle.module.system.mq.message.sensitiveword.SensitiveWordRefreshMessage;
