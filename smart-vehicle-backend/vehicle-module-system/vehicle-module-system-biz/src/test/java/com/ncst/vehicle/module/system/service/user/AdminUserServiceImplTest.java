package com.ncst.vehicle.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import com.ncst.vehicle.framework.common.enums.CommonStatusEnum;
import com.ncst.vehicle.framework.common.exception.ServiceException;
import com.ncst.vehicle.framework.common.pojo.PageResult;
import com.ncst.vehicle.framework.common.util.collection.ArrayUtils;
...
import com.ncst.vehicle.module.infra.api.file.FileApi;
import com.ncst.vehicle.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.ncst.vehicle.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.ncst.vehicle.module.system.controller.admin.user.vo.user.*;
import com.ncst.vehicle.module.system.dal.dataobject.dept.DeptDO;
import com.ncst.vehicle.module.system.dal.dataobject.dept.PostDO;
import com.ncst.vehicle.module.system.dal.dataobject.dept.UserPostDO;
...
import com.ncst.vehicle.module.system.dal.mysql.dept.UserPostMapper;
import com.ncst.vehicle.module.system.dal.mysql.user.AdminUserMapper;
import com.ncst.vehicle.module.system.enums.common.SexEnum;
import com.ncst.vehicle.module.system.service.dept.DeptService;
import com.ncst.vehicle.module.system.service.dept.PostService;
import com.ncst.vehicle.module.system.service.permission.PermissionService;
import com.ncst.vehicle.module.system.service.tenant.TenantService;
...
import static com.ncst.vehicle.framework.common.util.collection.SetUtils.asSet;
import static com.ncst.vehicle.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.ncst.vehicle.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.ncst.vehicle.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.ncst.vehicle.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.ncst.vehicle.framework.test.core.util.AssertUtils.assertServiceException;
import static com.ncst.vehicle.framework.test.core.util.RandomUtils.*;
import static com.ncst.vehicle.module.system.enums.ErrorCodeConstants.*;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("vehicleyuanma");
        ...
        assertEquals("vehicleyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("vehicleyuanma"))).thenReturn("java");
