package com.ncst.vehicle.module.member.service.user;
...
import com.ncst.vehicle.module.member.controller.app.user.vo.AppUserUpdateMobileReqVO;
...
import com.ncst.vehicle.module.member.service.auth.MemberAuthServiceImpl;
 ...
 * @author 宋天
 */
@Import({MemberUserServiceImpl.class, VehicleRedisAutoConfiguration.class})
