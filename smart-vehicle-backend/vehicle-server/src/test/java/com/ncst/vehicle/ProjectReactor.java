...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.ncst.smart";
    private static final String ARTIFACT_ID = "vehicle";
    private static final String PACKAGE_NAME = "com.ncst.vehicle";
    private static final String TITLE = "电动车管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.ncst.smart";
        String artifactIdNew = "vehicle";
        String packageNameNew = "com.ncst.vehicle";
        String titleNew = "电动车管理系统";
