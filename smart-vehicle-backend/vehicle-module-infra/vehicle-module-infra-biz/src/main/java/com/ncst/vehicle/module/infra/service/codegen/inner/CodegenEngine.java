package com.ncst.vehicle.module.infra.service.codegen.inner;
...
import com.ncst.vehicle.framework.common.exception.util.ServiceExceptionUtil;
...
import com.ncst.vehicle.framework.common.util.date.LocalDateTimeUtils;
import com.ncst.vehicle.framework.common.util.object.ObjectUtils;
import com.ncst.vehicle.framework.excel.core.annotations.DictFormat;
import com.ncst.vehicle.framework.excel.core.convert.DictConvert;
...
import com.ncst.vehicle.framework.operatelog.core.enums.OperateTypeEnum;
...
import com.ncst.vehicle.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "vehicle-module-${table.moduleName}/" + // 顶级模块
                "vehicle-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "vehicle-module-${table.moduleName}/" + // 顶级模块
                "vehicle-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "vehicle-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "vehicle-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
