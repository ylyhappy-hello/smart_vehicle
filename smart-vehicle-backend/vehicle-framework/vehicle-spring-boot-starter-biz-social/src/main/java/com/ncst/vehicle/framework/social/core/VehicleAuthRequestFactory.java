package com.ncst.vehicle.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import com.ncst.vehicle.framework.social.core.enums.AuthExtendSource;
import com.ncst.vehicle.framework.social.core.request.AuthWeChatMiniAppRequest;
 ...
 * @date 2021-10-31
 */
public class VehicleAuthRequestFactory extends AuthRequestFactory {
    ...
    public VehicleAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
