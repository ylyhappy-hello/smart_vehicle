package com.ncst.vehicle.framework.websocket.core;
...
public class VehicleWebSocketHandlerDecorator extends WebSocketHandlerDecorator {
    public VehicleWebSocketHandlerDecorator(WebSocketHandler delegate) {
        super(delegate);
    }
