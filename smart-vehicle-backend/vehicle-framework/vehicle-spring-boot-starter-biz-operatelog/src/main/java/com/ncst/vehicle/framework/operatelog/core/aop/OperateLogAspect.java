package com.ncst.vehicle.framework.operatelog.core.aop;
...
import com.ncst.vehicle.framework.operatelog.core.service.OperateLog;
import com.ncst.vehicle.framework.operatelog.core.service.OperateLogFrameworkService;
import com.ncst.vehicle.framework.web.core.util.WebFrameworkUtils;
...
import static com.ncst.vehicle.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.ncst.vehicle.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.ncst.vehicle.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.ncst.vehicle.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           com.ncst.vehicle.framework.operatelog.core.annotations.OperateLog operateLog,
