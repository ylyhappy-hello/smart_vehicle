package com.ncst.vehicle.framework.tracer.config;

import com.ncst.vehicle.framework.common.enums.WebFilterOrderEnum;
import com.ncst.vehicle.framework.tracer.core.aop.BizTraceAspect;
import com.ncst.vehicle.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "vehicle.tracer", value = "enable", matchIfMissing = true)
public class VehicleTracerAutoConfiguration {
