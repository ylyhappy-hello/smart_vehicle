package com.ncst.vehicle.framework.desensitize.core;

import com.ncst.vehicle.framework.common.util.json.JsonUtils;
import com.ncst.vehicle.framework.desensitize.core.regex.annotation.EmailDesensitize;
...
import com.ncst.vehicle.framework.desensitize.core.slider.annotation.BankCardDesensitize;
import com.ncst.vehicle.framework.desensitize.core.slider.annotation.CarLicenseDesensitize;
import com.ncst.vehicle.framework.desensitize.core.slider.annotation.ChineseNameDesensitize;
import com.ncst.vehicle.framework.desensitize.core.slider.annotation.FixedPhoneDesensitize;
import com.ncst.vehicle.framework.desensitize.core.slider.annotation.IdCardDesensitize;
import com.ncst.vehicle.framework.desensitize.core.slider.annotation.PasswordDesensitize;
import com.ncst.vehicle.framework.desensitize.core.slider.annotation.MobileDesensitize;
import com.ncst.vehicle.framework.desensitize.core.slider.annotation.SliderDesensitize;
