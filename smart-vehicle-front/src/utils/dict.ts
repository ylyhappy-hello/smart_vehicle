...
export enum DICT_TYPE {
  ...
  // ========== MOROCYCLE 模块 ==========
  MOTOCYCLE_CONSULT_TYPE = "motocycle_consult_type",
  MOTOCYCLE_DETECT_TYPE = "motocycle_detect_type",
  MOTOCYCLE_DETECT_MISTACK = "motocycle_detect_mistack",
  MOTOCYCLE_DETECT_MODEL_TYPE = "motocycle_detect_model_type",
  MOTOCYCLE_DATASET_TYPE = "motocycle_dataset_type",
  MOTOCYCLE_FIND_STATUS = "motocycle_find_status",
